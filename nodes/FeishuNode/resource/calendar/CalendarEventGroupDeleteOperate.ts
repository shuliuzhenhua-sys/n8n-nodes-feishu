...
export default {
	...
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
		...
		if (meetingChatId) qs.meeting_chat_id = meetingChatId;

		const requestOptions: IDataObject = { method: 'DELETE', url: `/open-apis/calendar/v4/calendars/${calendarId}/events/${eventId}/meeting_chat`, qs };
