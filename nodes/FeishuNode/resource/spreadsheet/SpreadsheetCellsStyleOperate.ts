...
const SpreadsheetCellsStyleOperate: ResourceOperations = {
	...
	async call(this: IExecuteFunctions, index: number): Promise<IDataObject> {
		...
		const body: IDataObject = { appendStyle: { range, style } };
		const requestOptions: IDataObject = { method: 'PUT', url: `/open-apis/sheets/v2/spreadsheets/${spreadsheetToken}/style`, body };
